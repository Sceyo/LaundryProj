        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex flex-column align-items-center justify-content-center my-3" href="<?php echo base_url()?>dashboard">
                <div class="sidebar-brand-icon">
                    ...
                    <div class="sidebar-brand-text mx-3">SmartWash <?php echo $username ?></div>
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url()?>expenditure">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?php echo base_url()?>Employee/report">Employee</a>
                        <a class="collapse-item" href="<?php echo base_url()?>Customer/report">Customer</a>
                        <a class="collapse-item" href="<?php echo base_url()?>Transactions/report">Transaction</a>
                        <a class="collapse-item" href="<?php echo base_url()?>Expenditure/report">Expenditure</a>
                    </div>
                </div>
            </li>

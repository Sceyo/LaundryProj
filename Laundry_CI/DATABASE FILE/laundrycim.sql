...
INSERT INTO `employee` (`employee_id`, `name_employee`, `gender`, `adress`, `number`, `salary`, `joinDate`, `endDate`, `actions`) VALUES
...
INSERT INTO `customer` (`id`, `customer_id`, `customername`, `address`, `contact`, `action`) VALUES
...
--
-- Table structure for table `expeditures`
--
...
INSERT INTO `expenditure` (`expenditure_id`, `total`, `detail`, `date`, `employee_id`) VALUES
...
CREATE TABLE `transaction` (
  ...
  `expenditure_id` char(7) NOT NULL,
  `employee_id` char(6) NOT NULL,
  `weight` int(11) NOT NULL,
  `total` int(11) NOT NULL,
  `tgl_order` date NOT NULL,
  `tgl_finished` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `transaction` (`transaction_id`, `expenditure_id`, `employee_id`, `weight`, `total`, `tgl_order`, `tgl_finished`) VALUES
